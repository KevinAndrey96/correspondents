                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class=" input-group input-group-outline my-3">
                                        <label for="productName" class="form-label">{{$productFields->product_name}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="productCommission" class="form-label">{{$productFields->product_commission}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="com_dis" class="form-label">{{$productFields->com_dis}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="com_shp" class="form-label">{{$productFields->com_shp}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="com_sup" class="form-label">{{$productFields->com_sup}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="fixed_commission" class="form-label">{{$productFields->fixed_commission}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="min_amount" class="form-label">{{$productFields->min_amount}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="max_amount" class="form-label">{{$productFields->max_amount}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="priority" class="form-label">{{$productFields->priority}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                            <label for="num_jineteo" class="form-label">{{$productFields->num_jineteo}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="productCommission" class="form-label">{{$productFields->hours}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-outline my-3">
                                        <label for="productCommission" class="form-label">{{$productFields->reassignment_minutes}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label for="accountType" class="ms-0">{{$productFields->account_type}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label for="email" class="ms-0">{{$productFields->email}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label for="extra" class="ms-0">{{$productFields->extra}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label for="code" class="ms-0">{{$productFields->code}}</label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label for="clientName" class="ms-0">{{$productFields->client_name}}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-4">
                                        <label for="image">{{$productFields->product_logo}}</label>
                                        <input type="file" class="form-control-file" name="image" value="" id="image">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="productDescription">{{$productFields->product_description}}</label>
