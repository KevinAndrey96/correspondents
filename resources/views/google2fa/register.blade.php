                                    ...
                                    <div class="col-md-12 mt-4">
                                        <div class="card card-default">
                                            ...
                                            <div class="card-body" style="text-align: center;">
                                                <p>Configure su autenticación de dos factores escaneando el código a continuación. Alternativamente, puede usar el código <strong>{{ $secret }}</strong></p>
                                                <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2">App Android</a>
                                                |
                                                <a href="https://apps.apple.com/us/app/google-authenticator/id388497605">App iOs</a>
                                                <div>
                                                    {!! $QR_Image !!}
                                                </div>
                                                <p>Debe configurar su aplicación Google Authenticator antes de continuar. De lo contrario, no podrá iniciar sesión luego</p>
                                                <div>
                                                    <a href="{{ route('complete.registration2') }}" class="btn btn-primary">Continuar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
