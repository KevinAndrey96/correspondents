                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-4 mb-5">
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <input id="minAmount" type="number" class="form-control" step="0.1" name="minAmount" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-4 mb-5">
                                        <div class="input-group input-group-outline mb-3">
                                            <label class="form-label">Penalidad</label>
                                            <input id="penalty" type="number" class="form-control" step="0.1" name="penalty" min="0" required>
                                        </div>
                                    </div>
                                </div>
