                        ...
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-1 pb-0">
                            <h6 class="text-white text-center text-capitalize ps-2 mx-6 "> <a href="{{route('brands.index')}}"
                                                                                              class="btn btn-block"><i style="color: white; margin-top: 13px;"
                                                                                                                       class="material-icons opacity-10">keyboard_return</i></a>Editar marca blanca</h6>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <form action="{{route('brands.update')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <div class=" input-group input-group-outline my-3">
                                            ...
                                            <input type="text" class="form-control" name="domain" id="domain" value="{{$brand->domain}}" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <input type="submit" class="btn btn-success bg-gradient" value="Modificar">
                                </div>
                            </form>
                        </div>
                    </div>
