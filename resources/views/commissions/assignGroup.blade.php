                            ...
                            <form method="POST" action="{{route('commissions.store-group-assignment')}}" enctype="multipart/form-data">
                                                    ...
                                                    @if ($item->comm_group_id == $commissionsGroup->id)
                                                        <div class="col-md-6 text-center mb-3">
                                                            <div class="w-100 border border-4 border-primary">
                                                                ...
                                                                <p class="text-center">COMISIÓN DISTRIBUIDOR: ${{number_format($item->generalCommission->amount_dis - $item->generalCommission->amount_shop, 2, ',', '.')}}</p>
                                ...
                                <div class="row mt-4 mb-4">
                                    <div class="col-md-12 mt-3 d-flex justify-content-center">
                                        @if (isset(Auth::user()->brand_id))
                                            <input style="background-image: linear-gradient(195deg, {{Auth::user()->brand->primary_color}} 0%, #191919 100%);" type="submit" class="btn text-white m-4 float-end" value="Asignar">
                                        @else
