                    ...
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-2 pe-1">
                                <h6 class="text-white font-weight-bolder text-center mt-1 mb-1">Contraseña diaria</h6>
                            </div>
                        </div>
                        <div class="card-body">
                            @if(Session::has('differentPass'))
                                <div class="alert alert-danger" role="alert">
                                    <p class="text-center text-sm text-white">{{ Session::get('differentPass') }}</p>
                                </div>
                            @endif
                            <form role="form" class="text-start" method="POST" action="{{ route('users.daily.password') }}">
                                @csrf
