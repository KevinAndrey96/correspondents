...
{
    public function reassignTransaction()
    {
            ...
            foreach ($transactions as $transaction) {
                ...
                if ($diffMinutes > 1) {
                    ...
                    foreach ($users as $user) {
                        ...
                        $output .= 'Este proveedor tiene asignadas ya ' . $numTransactions . ' transacciones,  puede recibir un máximo de ' . $user->max_queue .' transacciones\n';
