    ...
    public function isValid(Request $request)
    {
        if (Auth::user()->role == 'Administrator') {
            ...
            if($balance->is_valid == 1){
                ...
                $emailSubject = 'Saldo sustraído';
                $emailBody->body = 'La solicitud de recarga de saldo #'.$balance->id.' por valor de $'.$balance->amount.' fue invalidada a consideración de un administrador.';
            }
